		...
		<view class="details-top">
			<view class="user-info">
				...
				<view class="user-other">
					<view class="user-name"><text>{{ userDetails.remarksNanme }}</text>
						<uni-icons type="person-filled" color="rgb(0, 122, 255)" size="18"></uni-icons>
					</view>
					<view class="line-item">昵称：<text>{{ userDetails.loginName }}</text></view>
					<view class="line-item">账号：<text>{{userDetails.phone}}</text></view>
					<view class="line-item">地区：<text>四川 成都</text></view>
				</view>
			</view>
			<fn-item title="备注和标签" @click.native="setUserRemarksFn"></fn-item>
